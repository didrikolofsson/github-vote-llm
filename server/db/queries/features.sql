...
SET title = COALESCE(sqlc.narg('title')::text, title),
  ...
  review_status = COALESCE(sqlc.narg('review_status')::review_status_type, review_status),
  build_status = COALESCE(sqlc.narg('build_status')::build_status_type, build_status),
